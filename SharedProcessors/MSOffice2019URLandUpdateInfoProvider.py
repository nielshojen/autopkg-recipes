...
"""See docstring for MSOffice2019URLandUpdateInfoProvider class"""
...
__all__ = ["MSOffice2019URLandUpdateInfoProvider"]

# CULTURE_CODE defaulting to 'en-US' as the installers and updates seem to be
# multilingual.
CULTURE_CODE = "0409"
BASE_URL = "https://officecdn-microsoft-com.akamaized.net/pr/%s/MacAutoupdate/%s.xml"
...
class MSOffice2019URLandUpdateInfoProvider(Processor):
    """Provides a download URL for the most recent version of MS Office 2019."""
    input_variables = {
        "locale_id": {
            "required": False,
            "default": "1033",
    ...
    def get_installer_info(self):
        ...
        if self.env["version"] == "latest-standalone":
            ...
            item["Location"] = firstGroup + "2019_"+ secondGroup + "Installer.pkg"
...
if __name__ == "__main__":
    PROCESSOR = MSOffice2019URLandUpdateInfoProvider()
